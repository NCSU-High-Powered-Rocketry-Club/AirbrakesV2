...
class ApogeePredictor:
    ...
    @property
    def apogee_predictor_data_packet_queue_size(self) -> int:
        """
        Gets the amount of Apogee Predictor Data Packets in the queue
        :return: The number of ApogeePredictorDataPackets in the apogee predictor data packet queue.
        """
