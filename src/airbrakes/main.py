...
#     # uvx real -v: Shows the display with much more data
#     # uvx mock: Runs a simulation on your computer
#     # uvx mock -r: Runs a simulation on your computer with the real servo
#     # uvx mock -l: Runs a simulation on your computer and keeps the log file after the
#     # simulation stops
#     # uvx mock -f: Runs a simulation on your computer at full speed
#     # uvx mock -d: Runs a simulation on your computer in debug mode (doesn't show display)
#     args = arg_parser()
#     main(args)
