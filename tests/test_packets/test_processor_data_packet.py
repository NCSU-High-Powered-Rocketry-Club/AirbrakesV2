...
def processor_data_packet():
    return ProcessorDataPacket(
        ...
        integrating_for_altitude=TestProcessorDataPacket.integrating_for_altitude,
...
class TestProcessorDataPacket:
    ...
    def test_init(self, processor_data_packet):
        ...
        assert packet.integrating_for_altitude == self.integrating_for_altitude
